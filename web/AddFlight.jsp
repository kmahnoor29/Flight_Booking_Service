              ...
              <div class="row clearfix">
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      ...
                      <input type="number" name="flightno" class="form-control number" placeholder="Enter Flight No." required>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="input-group"><span class="input-group-addon">
                    ...
                    <div class="form-line">
                      <input type="text"  name="flightname" class="form-control text" placeholder="Enter Flight Name" required>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text"  name="depFrom" class="form-control text" placeholder="Enter Departure City" required>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text"  name="arrAt" class="form-control text" placeholder="Enter Arrival City" required>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text"  name="depTime" class="form-control time12" placeholder="Ex: 11:59 pm" required>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text"  name="arrTime" class="form-control time12" placeholder="Ex: 1:00 am" required>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text"  name="Date" class="form-control datetime" placeholder="Ex: 30/07/2016" required>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="number"  name="Customseats" class="form-control number" placeholder="Total Seats Ex: 80 ." required>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="number"  name="Ticketprice" class="form-control" placeholder="Enter Price" required>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="demo-switch">
                      <div class="switch">
                        <label> <b>OnGoing</b><input   name="BookingStatus" type="checkbox"  required ><span class="lever switch-col-pink"></span> <b>Closed</b> </label>
                      </div>
              ...
              <div class="row clearfix">
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text"  name="AirportName" class="form-control" placeholder="Enter Airport Name" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text"  name="AirportEmail" class="form-control" placeholder=" Enter Airport Address">
                    </div>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text"  name="AirportNo" class="form-control date" placeholder="Enter Phone N0.">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="card">
                    ...
                    <div class="body">
                      <div class="button-demo">
                        <input  style="font-size: 25px;"  type="submit" class="btn bg-pink btn-block waves-effect" value="Add Flight" />
                      </div>
                    </div>
                  </div>
                </div>
