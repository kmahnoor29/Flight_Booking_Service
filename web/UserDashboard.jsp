    ...
    <div class="menu">
      <ul class="list">
        ...
        <li>
          ...
          <a href="BookingPaymentReciept.jsp">
            ...
            <div class="header">
              <div class="row clearfix">
                <div class="col-xs-12 col-sm-6">
                  <h3 id="book-title">Please select your location</h3>
                </div>
                ...
                <div class="col-md-8">
                  <ul id="full-ad" class="geo-data">
                    <li>  <span id="Li"><i class="fa fa-map-marker col-teal"></i>  Address: </span><span id="location"></span></li>
                    <hr width="760px">

                    <li> <span id="Li"><i class="fa fa-arrows-h col-teal"></i>  Postal Code:</span><span id="postal_code"></span></li>
                    <hr width="760px">
                    <li><span id="Li"><i class="fa fa-flag col-teal"></i>  Country:</span><span id="country"></span></li>
                    <hr width="760px">
                    <li> <span id="Li"><i class="fa fa-long-arrow-up col-teal"></i>  Latitude:</span><span id="lat"></span></li>
                    <hr width="760px">
                    <li><span id="Li"><i class="fa fa-long-arrow-down col-teal"></i>  Longitude:</span><span id="lon"></span></li>
                    <hr width="760px">
                    <li><span id="Li"><i class="fa fa-globe col-teal"></i>  City: <span class="city" name="city" id="city"></span> </span></li>

                    <input id="input" name="City"
                           type="text"
                           class="Disable"
                           value="" hidden="" />

                    <input id="input2" name="ADDRESS"
                           type="text"
                           class="Disable"
                           value="" hidden="" />
